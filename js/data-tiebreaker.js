// Tie-breaker challenge bank for the universal session tie-breaker
// (js/tiebreaker.js). Add a new object to TIEBREAKER_CHALLENGES to put a new
// challenge type into rotation; extend the content arrays below to grow an
// existing one. No other code needs to change.
"use strict";

const TIEBREAKER_TRIVIA = [
